...
function nilaiKuliah(nama, matkul1, matkul2, matkul3) {
  ...
  var mean = (matkul1+matkul2+matkul3)/3;
  var result;
  if (mean >= 80) { 
    result = `Selamat ${nama}, grade kamu adalah A, Anda adalah lulusan terbaik`;
  } else if (mean >= 70 && mean < 80) {
    result = `Selamat ${nama}, grade kamu adalah B, Anda adalah lulusan kedua terbaik`;
  } else {
    result = `${nama}, grade kamu adalah C, Anda lulus`;
  }
  return result;
}
